...
export class FrontendStack extends Stack {
  constructor(parent: Stack, id: string, props: FrontendStackProps) {
    ...
    // S3
  const bucket = new Bucket(this, "ModBeautyCo", {
    bucketName: "modbeautyco.com",
  ...
  // Cloudfront
  const cf = new CloudFrontWebDistribution(this, "ModBeautyCDKCRAStaticDistribution", {
  ...
  // S3 Deployment
  const src = new BucketDeployment(this, "ModBeautyDeployCRA", {
